...
const Orders = () => {
	...
	const showOrdersLength = () => {
		if (orders.length > 0) {
			return <h4 className="text-danger display-2">Total orders: {orders.length}</h4>;
		} else {
						...
						return (
							<div className="mt-5" key={oIndex} style={{ borderBottom: '5px solid indigo' }}>
								...
								<ul className="list-group mb-2">
									...
									<li className="list-group-item">User ID: {o.user._id}</li>
									<li className="list-group-item">Email : {o.user.email}</li>
									<li className="list-group-item">Phone No: {o.user.phoneNo}</li>
