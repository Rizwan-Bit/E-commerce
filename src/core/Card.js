...
const Card = ({
	...
	const showAddToCartBtn = (showAddToCartButton, quantity) => {
		if (quantity > 0) {
			...
			return <label className="btn btn-outline-info mt-2 mb-2 card-btn-1">Try Later</label>;
		}
	};
	...
	const showStock = (quantity) => {
		...
		if (quantity > 5) {
			...
			return <span className="badge badge-warning badge-pill cw">Few Left</span>;
		} else {
			return <span className="badge badge-danger badge-pill">Out of Stock </span>;
		}
	};
